  ...
  function cambiarEstado(element, op) {
    ...
    const aux = lista.map((jugador) => {
      if (jugador._id === buscado) {
        if (op === 1) {
          if (jugador.juego2 === 'Playing') {
            return { ...jugador, "juego2": 'Undecided' };
          }
          else {
            return { ...jugador, "juego2": 'Playing' };
          }
        }
        else if (op === 2) {
          if (jugador.juego2 === 'Not playing') {
            return { ...jugador, "juego2": 'Undecided' };
          }
          else {
            return { ...jugador, "juego2": 'Not playing' };
          }
        }
        else if (op === 3) {
          return { ...jugador, "juego2": 'Undecided' };
                ...
                <TableCell >
                  <button
                    onClick={() => {
                      ...
                      backgroundColor: element.juego2 === 'Playing' ? 'green' : 'rgb(239,239,239)', // Cambia los colores aquí
                      color: element.juego2 === 'Playing' ? 'white' : 'black', // Cambia los colores aquí
                    }}>Playing</button>
                </TableCell>
                <TableCell>
                  <button onClick={() => {
                    ...
                    backgroundColor: element.juego2 === 'Not playing' ? 'red' : 'rgb(239,239,239)', // Cambia los colores aquí
                    color: element.juego2 === 'Not playing' ? 'white' : 'black', // Cambia los colores aquí
                  }} >Not Playing</button>
                </TableCell>
                <TableCell>
                  <button onClick={() => {
                    ...
                    backgroundColor: element.juego2 === 'Undecided' ? 'yellow' : 'rgb(239,239,239)'// Cambia los colores aquí
                  }} >Undecided</button>
                </TableCell>
              </TableRow>
            ))
